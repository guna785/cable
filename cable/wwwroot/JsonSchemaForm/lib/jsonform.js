...
jsonform.elementTypes = {
  ...
  'select':{
      'template': '<select name="<%= node.name %>" id="<%= id %>" style="width:100%;padding:8px;"' +
      'class=\'form-control<%= (fieldHtmlClass ? " " + fieldHtmlClass : "") %>\'' +
  ...
  'array': {
    'template': '<div id="<%= id %>"><ul class="_jsonform-array-ul" style="list-style-type:none;"><%= children %></ul>' +
      '<span class="_jsonform-array-buttons">' +
        '<a href="#" class="btn btn-default _jsonform-array-addmore" title="Add New"><img src="/img/add-outline.svg" width="20" height="20"></a> ' +
        '<a href="#" class="btn btn-default _jsonform-array-deletelast" title="Delete last"><img src="/img/remove-outline.svg" width="20" height="20"></a>' +
      '</span>' +
      '</div>',
    'fieldtemplate': true,
    'array': true,
  ...
  'tabarray': {
    'template': '<div id="<%= id %>"><div class="tabbable tabs-left">' +
      ...
      '</div>' +
      '<a href="#" class="btn btn-default _jsonform-array-addmore" title="Add New"><img src="/img/add-outline.svg" width="20" height="20"></a> ' +
      '<a href="#" class="btn btn-default _jsonform-array-deleteitem" title="Delete item"><img src="/img/remove-outline.svg" width="20" height="20"></a></div>',
    'fieldtemplate': true,
    'array': true,
    'childTemplate': function (inner) {
